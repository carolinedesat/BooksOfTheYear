...
router.get('/get/html', function(req, res) {
    ...
    let xml = fs.readFileSync('booksoftheyear.xml', 'utf8'),
        xsl = fs.readFileSync('booksoftheyear.xsl', 'utf8');
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        XMLtoJSON('booksoftheyear.xml', function (err, result) {
            ...
            result.menu.section[obj.sec_n].entry.push({'book': obj.book, 'author': obj.author});

            console.log(JSON.stringify(result, null, "  "));

            JSONtoXML('booksoftheyear.xml', result, function(err){
